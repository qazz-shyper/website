...
// Session is session based settings for controlling Website requests. It contains various settings (or limits) that may differ for different users in the context.
type Session struct {
...
type Manager interface {
	...
	// ForSystem returns the System policy for Website system.
	ForSystem() System
}
