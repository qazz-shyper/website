...
import (
	...
	"github.com/qazz-shyper/website/features/inbound"
...
// Server is an instance of Website. At any time, there must be at most one Server instance running.
...
// Instance combines all functionalities in Website.
...
// New returns a new Website instance based on given configuration.
// The instance is not started at this point.
// To ensure Website instance works properly, the config must contain one Dispatcher, one InboundHandlerManager and one OutboundHandlerManager. Other features are optional.
...
// Close shutdown the Website instance.
...
// Start starts the Website instance, including all registered features. When Start returns error, the state of the instance is unknown.
// A Website instance can be started only once. Upon closing, the instance is not guaranteed to start again.
//
// xray:api:stable
func (s *Instance) Start() error {
	...
	newError("Website ", Version(), " started").AtWarning().WriteToLog()
