...
var cmdRun = &base.Command{
	...
	Short:     "Run Website with config, the default command",
	Long: `
Run Website with config, the default command.

The -config=file, -c=file flags set the config files for 
Website. Multiple assign is accepted.
...
The -test flag tells Website to test config files only, 
...
var (
	configFiles cmdarg.Arg // "Config file for Website.", the option is customed type, parse in main
	configDir   string
	test        = cmdRun.Flag.Bool("test", false, "Test config file only, without launching Website server.")
	 ...
	 */
	_ = func() bool {
		cmdRun.Flag.Var(&configFiles, "config", "Config path for Website.")
...
func startWebsite() (core.Server, error) {
