...
var (
	...
	certCommonName   = cmdCert.Flag.String("name", "Website Inc", "The common name of this certificate")
	certOrganization = cmdCert.Flag.String("org", "Website Inc", "Organization of the certificate")
