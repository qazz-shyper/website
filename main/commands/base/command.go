...
// LongName returns the command's long name: all the words in the usage line between first word (e.g. "website") and a flag or argument,
...
func (c *Command) Usage() {
	...
	fmt.Fprintf(os.Stderr, "Run 'website help %s' for details.\n", c.LongName())
	SetExitStatus(2)
	Exit()
}
